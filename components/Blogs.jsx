...
const BlogsPage = () => {
  ...
  return (
    ...
    >
      <motion.h2
        className="text-4xl  mb-6 mt-4 font-serif tracking-tighter text-black dark:text-white"
        variants={child}
      >
        All Blogs
      </motion.h2>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h3 className="text-xl font-serif  tracking-tight text-black dark:text-white">
          {blog.title}
        </h3>
