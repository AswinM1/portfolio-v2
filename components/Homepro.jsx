...
>
  <motion.h2
    className="text-3xl text-black dark:text-white font-medium tracking-tighter font-serif"
    variants={child}
  >
    Projects
  </motion.h2>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h3 className="text-lg font-sans tracking-tight text-black dark:text-white font-medium mb-2">
          {project.name}
        </h3>
        ...
        <div className="text-black dark:text-white flex flex-wrap gap-3">
          {project.techStack.map((tech, idx) => (
            <span
              key={idx}
              className="font-medium bg-neutral-800  dark:bg-neutral-700 text-white text-sm  dark:text-white py-1 px-2 rounded-lg"
            >
              {tech}
            </span>
          ))}
